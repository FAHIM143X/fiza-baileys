...
<div align="center">
  ...
  <img src="https://raw.githubusercontent.com/fahimthetechie/database/refs/heads/main/image/fahim.png" width="350px">
...
```typescript
// ESM 
import makeWASocket from 'fiza-baileys'
```
</div>
...
```javascript
// CommonJS
const { default: makeWASocket } = require("fiza-baileys")
```
</div>
</div>
</div>
...
<div style="display: flex; flex-wrap: wrap; gap: 15px; margin: 20px 0;">
  <div style="flex: 1; min-width: 250px; background: rgba(59, 130, 246, 0.05); border-radius: 10px; padding: 15px;">
    ...
    <p>Add fiza-baileys to your project using npm</p>
    <div style="background: rgba(0, 0, 0, 0.2); padding: 10px; border-radius: 5px;">
      <code>npm install fiza-baileys</code>
    </div>
  </div>
  ...
  <div style="flex: 1; min-width: 250px; background: rgba(59, 130, 246, 0.05); border-radius: 10px; padding: 15px;">
    ...
    <div style="background: rgba(0, 0, 0, 0.2); padding: 10px; border-radius: 5px;">
      <code>import makeWASocket from 'fiza-baileys'</code>
    </div>
  </div>
...
<div style="background: linear-gradient(135deg, rgba(239, 68, 68, 0.05), rgba(220, 38, 38, 0.05)); border-radius: 10px; padding: 20px; margin: 20px 0;">
  ...
  <p>If you encounter any issues while using this repository, please feel free to open a <a href="https://github.com/FAHIM143X/fiza-baileys/issues" style="color: #60A5FA; text-decoration: none; font-weight: bold;">new issue</a>.</p>
